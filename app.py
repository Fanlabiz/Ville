...
Version finale corrigée - Problème d'initialisation résolu
"""
...
class Terrain:
    ...
    def __init__(self, df_terrain):
        ...
        self.original_buildings = {}  # Initialiser AVANT _parse_terrain
        self.grid = None
        self.height = 0
        self.width = 0
...
class ExcelExporter:
    ...
    def _create_terrain_sheet(ws: Worksheet, terrain: Terrain):
        ...
        # Créer toutes les cellules avec les valeurs originales
        ...
        # Ajouter les bâtiments optimisés (décalés par rapport aux bordures)
        building_first_cells = {}
        for instance in terrain.building_instances:
            cells = instance.get_occupied_cells()
            if cells:
                min_cell = min(cells, key=lambda c: (c[0], c[1]))
                # Ajouter l'offset des bordures
                real_i = min_cell[0] + border_offset[0] + 1
                real_j = min_cell[1] + border_offset[1] + 1
                building_first_cells[(real_i, real_j)] = instance
        ...
        try:
            ...
            with st.spinner("Optimisation avancée en cours..."):
                ...
                2. Consultez l'onglet **Terrain_final** pour voir le placement optimisé
                   ...
                   - Seuls les bâtiments optimisés sont affichés
