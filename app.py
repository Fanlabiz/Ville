...
class Terrain:
    def __init__(self, grid):
        ...
        self.cultural_zone = np.zeros_like(self.grid, dtype=int)  # Somme des cultures
    ...
    def get_best_cultural_position(self, building):
        ...
        for x, y, o in positions:
            # 1. Zone de rayonnement dans le terrain
        ...
        # STRATÉGIE CORRIGÉE :
        # 1. Priorité maximale : éviter les couloirs ET maximiser l'impact sur producteurs existants
        if best_existing_pos is not None:
            return best_existing_pos
        # 2. Sinon, éviter les couloirs ET zone dans le terrain
...
def main():
    ...
    st.title("🏗️ Placeur de bâtiments - Priorité aux producteurs existants")
    ...
    if st.button("🚀 Lancer", type="primary"):
        with st.spinner("Placement..."):
            ...
            st.write("🔄 Algorithme alterné - Priorité aux producteurs existants")
            ...
            while cult or prod:
                ...
                if prod:
                    ...
                    # Afficher la carte des valeurs culturelles au premier cycle
