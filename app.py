...
if uploaded:
    with st.spinner("Analyse du fichier en cours..."):
        try:
            ...
            # Création du planner (sans charger les bâtiments)
            ...
            # Maintenant charger les bâtiments avec les dimensions connues
            if a_df is not None:
                planner.load_existing_buildings(a_df.values)
            
            # Associer les bâtiments existants avec leurs caractéristiques
            unmatched, matched = planner.match_buildings_with_info(all_buildings)
