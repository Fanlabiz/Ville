...
def _csv_building_category(nom_complet):
    ...
    if "BARRACKS" in n:
        return "Barracks"
    if "FARM" in n or "CAMELFARMED" in n \
    ...
    if "WORKSHOP" in n or "SMITHY" in n or "FORGE" in n \
            ...
            or "SADDLER" in n or "MERCHANT" in n:
        return "Workshop"
    return None
    ...
    if uploaded_csv is not None:
        ...
        with _col_p2:
            _prio_farm = st.number_input(
                ...
                help="Bâtiments contenant 'Farm', 'Irrigation' ou 'Camel' dans le nom technique"
            )
        with _col_p3:
        ...
        with _col_p4:
            _prio_workshop = st.number_input(
                ...
                help="Bâtiments contenant 'Workshop', 'Smithy', 'Forge', 'Carpenter', 'Pottery', 'Merchant'…"
            )
    else:
