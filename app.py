...
class CityPlanner:
    ...
    def load_existing_buildings(self, actuel_data):
        ...
        # Stocker la liste pour l'affichage ultérieur
...
if uploaded:
    with st.spinner("Analyse du fichier en cours..."):
        try:
            ...
            # Récupérer la liste des bâtiments détectés si elle existe
            if hasattr(planner, 'last_detected'):
                buildings_detected = planner.last_detected
            ...
            # Afficher les bâtiments non associés s'il y en a
            if unmatched:
