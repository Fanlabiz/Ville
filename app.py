...
if uploaded:
    ...
    if st.button("Lancer l'optimisation", type="primary"):
        ...
        if optionnels_a_placer:
            ...
            _score_before_opts = score_placement(optimized)
            _no_improve_streak = 0
            _MAX_NO_IMPROVE = 3  # arrêter après 3 optionnels sans gain
            for _opt_b in _opts_sorted:
                ...
                if _pos is not None:
                    ...
                    if _gain > 0:
                        ...
                        if _no_improve_streak >= _MAX_NO_IMPROVE:
                            break  # plus de gain attendu pour les suivants
                else:
                    _no_improve_streak += 1
                    if _no_improve_streak >= _MAX_NO_IMPROVE:
                        break
