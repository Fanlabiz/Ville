...
batiments_tries = sorted(batiments, key=lambda b: b["longueur"] * b["largeur"], reverse=T
...
return buf
# ── Interface ────────────────────────────────────────────────────────────────
st.title(" Placement de Bâtiments")
st.markdown("Uploadez votre fichier Excel pour placer automatiquement vos bâtiments sur le te
...
with col3:
with col4:
st.markdown(f'<div class="metric-card"><div class="value">{nb_lignes}×{nb_cols}</
st.markdown(f'<div class="metric-card"><div class="value">{cases_libres}</div><di
st.markdown(f'<div class="metric-card"><div class="value">{len(batiments)}</div><
st.markdown(f'<div class="metric-card"><div class="value">{surface_bats}</div><di
